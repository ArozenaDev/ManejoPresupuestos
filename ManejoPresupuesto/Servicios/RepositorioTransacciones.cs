...
namespace ManejoPresupuesto.Servicios
{
    ...
    {
        Task Actualizar(Transaccion transaccion, decimal cantidadAnterior, int cuentaAnterior);
        Task Borrar(int id);
    ...
    public class RepositorioTransacciones : IRepositorioTransacciones
    {
        ...
        {
            using var connection = new SqlConnection(connectionString);
            return await connection.QueryAsync<Transaccion>(@"SELECT t.Id, t.Cantidad, t.FechaTransaccion, c.Nombre as Categoria,
        ...
        public async Task<IEnumerable<ResultadoObtenerPorMes>> ObtenerPorMes(int usuarioId, int año)
        {
            ...
            return await connection.QueryAsync<ResultadoObtenerPorMes>(@"SELECT MONTH(FechaTransaccion) as Mes,
                                                                        SUM(Cantidad) as Cantidad, cat.TipoOperacionId
                                                                        FROM Transacciones
        ...
        public async Task Actualizar(Transaccion transaccion, decimal cantidadAnterior, int cuentaAnteriorId)
        {
            using var connection = new SqlConnection(connectionString);
